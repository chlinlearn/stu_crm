		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				...
				<div id="collapseListGroup3" class="panel-collapse collapse in"
					...
					<ul class="list-group">
						<li class="list-group-item"><a href="course/list.action">
								<i class="fa fa-flash fa-fw"></i> 课程管理
						</a></li>

						<li class="list-group-item"><a href="crmclass/list.action">
				...
				<div id="collapseListGroup5" class="panel-collapse collapse in"
					...
					<ul class="list-group">
						<li class="list-group-item"><a href="department/list.action">
								<i class="fa fa-dashboard fa-fw"></i> 部门管理
						</a></li>

						<li class="list-group-item"><a href="crmpost/list.action">
								<i class="fa fa-comment-o fa-fw"></i> 职务管理
						</a></li>

						<li class="list-group-item"><a href="crmstaff/list.action">
