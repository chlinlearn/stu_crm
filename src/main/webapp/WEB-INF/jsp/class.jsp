...
<title>学员关系管理系统CRM</title>
	<!-- 引入css样式文件 -->
	<!-- Bootstrap Core CSS -->
	<link href="http://localhost:8092/stu_crm/css/bootstrap.min.css" rel="stylesheet">
	<!-- MetisMenu CSS -->
	<link href="http://localhost:8092/stu_crm/css/metisMenu.min.css" rel="stylesheet">
	<!-- DataTables CSS -->
	<link href="http://localhost:8092/stu_crm/css/dataTables.bootstrap.css" rel="stylesheet">
	<!-- Custom CSS -->
	<link href="http://localhost:8092/stu_crm/css/sb-admin-2.css" rel="stylesheet">
	<!-- Custom Fonts -->
	<link href="http://localhost:8092/stu_crm/css/font-awesome.min.css" rel="stylesheet" type="text/css">
	<link href="http://localhost:8092/stu_crm/css/boot-crm.css" rel="stylesheet" type="text/css">
    <style>
	...
	<div id="page-wrapper">
		...
		<!-- 搜索部分 -->
			<div class="panel-body">
				<form class="form-inline" method="get" action="crmclass/list.action">
					<div class="form-group">
						<label for="crmclassName">班级名称</label> 
						<input type="text" class="form-control" id="crmclassName" value="" name="name">
					</div>
					 <div class="form-group">
			...
			<div class="modal-body">
				<form class="form-horizontal" id="new_crmclass_form">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="new_crmclassName" placeholder="班级名称" name="name">
						</div>
					</div> 
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="datetime-local" class="form-control" id="new_begintime" placeholder="开班时间" name="begintime">
						</div>
						<label for="new_endtime" class="col-sm-2 control-label">
						   毕业时间
						</label>
						<div class="col-sm-4">
							<input type="datetime-local" class="form-control" id="new_endtime" placeholder="毕业时间" name="endtime">
						</div>
					</div> 
					<div class="form-group">
			...
			<div class="modal-body">
				<form class="form-horizontal" id="edit_crmclass_form">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="edit_crmclassName" placeholder="班级名称" name="name">
						</div>
					</div> 
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="datetime-local" class="form-control" id="edit_begintime" placeholder="开班时间" name="begintime">
						</div>
						<label for="edit_endtime" class="col-sm-2 control-label">
						   毕业时间
						</label>
						<div class="col-sm-4">
							<input type="datetime-local" class="form-control" id="edit_endtime" placeholder="毕业时间" name="endtime">
						</div>
					</div> 
					<div class="form-group">
...
<!-- 引入js文件 -->
<!-- jQuery -->
<script src="http://localhost:8092/stu_crm/js/jquery-1.11.3.min.js"></script>
<!-- Bootstrap Core JavaScript -->
<script src="http://localhost:8092/stu_crm/js/bootstrap.min.js"></script>
<!-- Metis Menu Plugin JavaScript -->
<script src="http://localhost:8092/stu_crm/js/metisMenu.min.js"></script>
<!-- DataTables JavaScript -->
<script src="http://localhost:8092/stu_crm/js/jquery.dataTables.min.js"></script>
