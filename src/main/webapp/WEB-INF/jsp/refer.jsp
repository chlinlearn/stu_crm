			...
			<div class="panel-body">
				<form class="form-inline" method="get" action="refer/list.action">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="referName" value="" name="referName">
					</div>
					<div class="form-group">
						<label for="referFrom">咨询来源</label> 
						<select class="form-control" id="referFrom" name="referSource">
					...
					<div class="form-group">
						...
						<select class="form-control" id="referUser" name="referUser">
							<option value="">--请选择--</option>
							<option value="4">
								    海丽</option>
							</select>
			...
			<div class="modal-body">
				<form class="form-horizontal" id="new_refer_form">
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" id="new_cname" placeholder="学生姓名" name="cname">
						</div>
					...
					<div class="form-group">
						<label for="new_resLevel" class="col-sm-2 control-label">
						 资源级别</label>
						<div class="col-sm-4">
							<select class="form-control" id="new_resLevel" name="resourcelevel">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" id="new_cmail" placeholder="Email地址" name="cmail">
						</div>
					</div>
					<div class="form-group">
				...
				<form class="form-horizontal" id="edit_refer_form">
					<input type="hidden" id="edit_id" name="id">
					 <div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" id="edit_cname" placeholder="学生姓名" name="cname">
						</div>
					...
					<div class="form-group">
						<label for="edit_resLevel" class="col-sm-2 control-label">
						 资源级别</label>
						<div class="col-sm-4">
							<select class="form-control" id="edit_resLevel" name="resourcelevel">
								<option value="A">--A--</option>
								<option value="B">--B--</option>
								<option value="C">--C--</option>
								<option value="D">--D--</option>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" id="edit_cmail" placeholder="Email地址" name="cmail">
						</div>
					</div>
					<div class="form-group">
